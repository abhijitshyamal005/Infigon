    ...
    const renderContent = (id: string) => {
        ...
        switch (id) {
            case 'PersonalityExplorer':
                return (
                    <div className="pl-9 pr-2 py-3 space-y-2 text-sm block">
                        <p className="text-gray-700 font-medium">Understanding Personality Explorer</p>
                        <div>
                            <button
                                onClick={() => setActiveComponent("PersonalityTypes")}
                                className="text-gray-500 hover:text-blue-500 block"
                            >
                                Personality Types
                            </button>
                        </div>
                        <div>
                            <button
                                onClick={() => setActiveComponent("YourResult")}
                                className="text-gray-500 hover:text-blue-500 block"
                            >
                                Your Result
                            </button>
